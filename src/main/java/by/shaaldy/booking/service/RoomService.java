...
public class RoomService {
    ...
    public RoomResponse create(CreateRoomRequest request) throws ResourceNotFoundException {
        ...
        Hotel hotel = hotelRepository.findById(request.getHotelId()).orElseThrow(() -> new ResourceNotFoundException("Hotel", "id", request.getHotelId()));
    ...
    public List<RoomResponse> getByHotelId(Long hotelId) throws ResourceNotFoundException {
        ...
        return roomRepository.findByHotelId(hotelId).stream().map(roomMapper::toResponse).collect(Collectors.toList());
    }
